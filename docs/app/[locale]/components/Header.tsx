      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex gap-6 md:gap-10">
          ...
          <nav className="hidden md:flex gap-6">
            <Link href="/docs/1-architecture/system-overview" className="flex items-center text-sm font-medium text-muted-foreground transition-colors hover:text-primary">
              {translations.docs}
            </Link>
        ...
        <div className="flex items-center space-x-4">
          <Link href="/docs/1-architecture/system-overview" className="hidden md:block">
